// var inputThePwd = document.getElementById('the-pwd'),
//     icon = document.getElementById('icon');

//    icon.onclick = function () {

//      if(inputThePwd.className == 'active') {
//         inputThePwd.setAttribute('type', 'text');
//         icon.className = 'fa fa-eye';
//        inputThePwd.className = '';

//      } else {
//         inputThePwd.setAttribute('type', 'password');
//         icon.className = 'fa fa-eye-slash';
//        inputThePwd.className = 'active';
//     }
//    }
